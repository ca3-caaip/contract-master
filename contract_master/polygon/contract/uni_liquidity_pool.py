...
class UniLiquidityPool(Contract):
    ...
    def balance_of(
        ...
        token0: str = self.contract.functions.token0().call(
            block_identifier=block_identifier
        )
        token1: str = self.contract.functions.token1().call(
            block_identifier=block_identifier
        )
        reserves: list[int] = self.contract.functions.getReserves().call(
            block_identifier=block_identifier
        )
        ...
        user_balance: int = self.contract.functions.balanceOf(account).call(
            block_identifier=block_identifier
        )
